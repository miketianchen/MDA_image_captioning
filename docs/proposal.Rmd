...
To break the problem down, we will be working with public captioned datasets first. We will be merging several different datasets into one, and we will clean and organize the data into a database. We will both train and test the model on this data. Once we are satisfied with the performance on the captioned datasets, the model will be tested on the MDA dataset.
