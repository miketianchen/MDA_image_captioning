...
Second, the deep learning model will be capapble of loading data from the database, as well as train and predict on data. The model will be designed to be easy to maintain and update. PyTorch would be used for modelling and AWS P2 or P3 instances would be used for cloud computing.

Lastly, a Dash-based visualization would allow users to get predicted captions from the model and update new image-caption pairs in the database. Users would have two options, either to select one or multiple images from the database or upload any new ones outside the database. The images, machine-generated captions, human-annotated captions and scores would be displayed as results.
