...
kable(test, 
      caption = "Evaluation scores from the best model of each structure on the test dataset (Combined RSICD and UCM datasets).")
```
...
kable(sydney, 
      caption = "Evaluation scores from the best model of each structure on the Sydney dataset.")
```
