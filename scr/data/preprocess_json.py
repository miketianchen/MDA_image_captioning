...
'''This script preprocess the original json file and correct problematic captions. 
This script takes a raw data folder path and save the files in the desired folder.

Usage: scr/data/preprocess_json.py --input_path=<input_path> --output_path=<output_path>
